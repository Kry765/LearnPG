...
const handleTopicData = require('./imports/insertCreateTopic')
const handleOpenQuestionData = require('./imports/insertOpenQuestion')
const handleCloseQuestionData = require('./imports/insertCloseQuestion')
...
db.authenticate()
	...
	.then(async () => {
		...
		await handleFaqData()
		await handleTopicData()
		await handleOpenQuestionData()
		await handleCloseQuestionData()
	})
	.then(() => {
		app.listen(port, () => {
